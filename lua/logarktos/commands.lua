...
local function specs()
	return {
		...
		{ "Work", "WorkMode", function() layouts().work_mode_tab() end, { desc = "WorkMode: three panes from logarktos.lua (terminal / oil / empty)" } },
		{ "HereWork", "HereWorkMode", function() layouts().here_work_mode() end, { desc = "WorkMode in the current tab" } },
